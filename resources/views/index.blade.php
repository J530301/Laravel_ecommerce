...
>
    <!-- Modal Overlay -->
<div id="productOverlay" class="fixed inset-0 bg-black bg-opacity-50 hidden z-[102] flex items-center justify-center px-2 py-4">
    <div class="relative w-full max-w-xs sm:max-w-lg md:max-w-2xl lg:max-w-3xl bg-white rounded-2xl shadow-2xl overflow-hidden border-0 animate-fade-in mx-auto flex flex-col"
        style="max-height: 95vh;">
        <!-- Modal Header -->
        <div class="flex flex-row items-center justify-between px-4 sm:px-8 py-4 sm:py-6 bg-gradient-to-r from-blue-500 to-green-400 rounded-t-2xl gap-2">
            ...
            @endif
            <button id="closeOverlay" class="text-white text-3xl font-bold hover:text-red-200 transition leading-none flex-shrink-0" aria-label="Close">&times;</button>
        </div>
        <!-- Modal Body -->
        <div class="flex flex-col md:flex-row gap-8 px-4 sm:px-8 py-6 sm:py-8 bg-gray-50 overflow-y-auto flex-1">
            <!-- Image Section -->
            <div class="w-full md:w-1/2 flex items-center justify-center">
                <div class="relative w-full flex items-center justify-center bg-gray-100 rounded-xl shadow-inner" style="min-height:200px;">
                    <img src="" id="overlayImage" class="max-w-full max-h-[320px] object-contain transition-transform duration-300 hover:scale-105" alt="Product Image">
                    @if(auth()->user()->role === 'admin')
